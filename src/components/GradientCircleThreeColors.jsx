...
const GradientCircleThreeColors = () => {
  const [color1, setColor1] = useState("#5c3566");
  const [color2, setColor2] = useState("#f83a3a");
        ...
        <Box sx={{ mt: "50px", overflow: "auto", borderRadius: "10px" }}>
          <Box
            sx={{
              ...
              backgroundImage: `radial-gradient(circle, ${color1}, ${color2}, ${color3})`,
            }}
          >
            <Typography
...
export default GradientCircleThreeColors;
